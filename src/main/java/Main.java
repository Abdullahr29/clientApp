...
public class Main {
    ...
    public static void makeGetRequest(){
        URL myURL = null;
        try {
            myURL = new URL("http://arservertestpro.herokuapp.com/patients");
    ...
    public static void makePostRequest() throws MalformedURLException, IOException{
        URL myURL = new URL("http://localhost:8080/untitled/patients");
        Patient p = new Patient("Mireia", 69, "012345");
        Gson gson = new Gson();
    ...
    public static void sqlFunction(){
        ...
        try {
            conn = DriverManager.getConnection(dbUrl, "postgres", "Swordsmanship49");
